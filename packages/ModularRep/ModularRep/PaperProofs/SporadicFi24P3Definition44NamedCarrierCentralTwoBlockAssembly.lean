import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoAD3Assembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoBlockAssembly
...
theorem central_two_manuscript_block_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3⟩ :=
    SporadicFi24P3Definition44NamedCarrierCentralTwoAD3Assembly.central_two_manuscript_ad3_assembly iota R E hC hOuter hAut hZ compatibility availability nu0 principle e0 he0
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3,
    matched_block_output_of_base iota
      ...
      (Or.inr (Or.inl hZ)) e0 hblock e hIndependent compatibility⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoBlockAssembly
