...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulBlockAssembly
...
theorem faithful_manuscript_block_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3⟩ :=
    SporadicFi24P3Definition44NamedCarrierFaithfulAD3Assembly.faithful_manuscript_ad3_assembly iota R hOuter tau hcard hinverts compatibility availability nu0 e0 he0
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3,
    matched_block_output_of_base iota
      ...
      (Or.inr (Or.inr ⟨hcard, tau, hinverts⟩)) e0 hblock e hIndependent compatibility⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulBlockAssembly
