...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringPhysicalRows
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringCenterlessRows
...
open SporadicFi24P3Definition44NamedCarrierSignedCoveringPhysicalRows
...
theorem centerless_positive_block_output_of_signed_covering
  ...
  exact every_embedded_physical_model_pair_blocks_of_index_two iota phi.val V source
    ...
    h2 (actual_quotient_card_le_two iota phi.val hOuter) S820 (fun n => rfl) hinj R.1.operations.ambientBlockData dataN
    ((hBlocks.2 phi V hmatch).2.2 source) (seed phi)
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringCenterlessRows
