import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierMonsterOddSources
...
/-! Conditional Monster odd-prime join. The kernel-one universal full
cover identifies the actual simple group as its own prime-to-p cover.
The guarded An--Wilson numerical input is applied only when 3 <= p. -/

noncomputable section

namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierMonsterOddFullCover
...
theorem exists_definition41_of_full_cover_and_monster_odd_sources
  ...
  exact SporadicFi24P3Definition44NamedCarrierCanonicalJ4Numerical.exists_definition41_of_defect_counts iota hinj R C
    ...
    (allAutomorphismsInner_of_outer_card_one hOuter) D T
    (source.toDefectCounts iota hinj R hpOdd) compatibility fieldSource

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierMonsterOddFullCover
