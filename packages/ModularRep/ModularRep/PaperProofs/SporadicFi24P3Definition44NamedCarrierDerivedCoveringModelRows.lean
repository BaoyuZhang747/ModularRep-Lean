...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierModelRestrictionTopBlockChoice
...
complete intermediate-block output without the general restriction source. -/

noncomputable section
open scoped MonoidAlgebra

namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierDerivedCoveringModelRows
...
open SporadicFi24P3Definition44NamedCarrierModelRestrictionTopBlockChoice
...
theorem embedded_model_pair_blocks_of_literal_restriction
  ...
  · obtain ⟨BA, ⟨dataA⟩⟩ := ambient hB
    ...
    obtain ⟨selectedGlobal, htop⟩ :=
      exists_global_extension_with_induced_block_of_literal_restriction
        S9495 S820 B D rA rB rD rM hrootsG fieldSource hcyclic
        ...
        phiB phiM initialGlobal fixedLocal sigma rhoL hres hLocal haffordsL
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierDerivedCoveringModelRows
