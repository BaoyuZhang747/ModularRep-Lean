...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierTrivialRowChecks020

theorem reconstruction_row_20 : ∀ j : Fin 41,
    checkEq (reconstructionResidual 20 j)
      (mul (modulus (columnTag j)) (reconstructionQuotient 20 j)) = true := by decide

theorem duplicate_row_20 : ∀ c : Fin 91,
    rawRow 20 c = row 20 (columnLabel c) := by decide

theorem reconstruction_row_21 : ∀ j : Fin 41,
    checkEq (reconstructionResidual 21 j)
      (mul (modulus (columnTag j)) (reconstructionQuotient 21 j)) = true := by decide

theorem duplicate_row_21 : ∀ c : Fin 91,
    rawRow 21 c = row 21 (columnLabel c) := by decide

theorem reconstruction_row_22 : ∀ j : Fin 41,
    checkEq (reconstructionResidual 22 j)
      (mul (modulus (columnTag j)) (reconstructionQuotient 22 j)) = true := by decide

theorem duplicate_row_22 : ∀ c : Fin 91,
    rawRow 22 c = row 22 (columnLabel c) := by decide

theorem reconstruction_row_23 : ∀ j : Fin 41,
    checkEq (reconstructionResidual 23 j)
      (mul (modulus (columnTag j)) (reconstructionQuotient 23 j)) = true := by decide

theorem duplicate_row_23 : ∀ c : Fin 91,
    rawRow 23 c = row 23 (columnLabel c) := by decide

theorem reconstruction_row_24 : ∀ j : Fin 41,
    checkEq (reconstructionResidual 24 j)
      (mul (modulus (columnTag j)) (reconstructionQuotient 24 j)) = true := by decide

theorem duplicate_row_24 : ∀ c : Fin 91,
    rawRow 24 c = row 24 (columnLabel c) := by decide

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierTrivialRowChecks020
