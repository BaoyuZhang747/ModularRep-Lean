...
actual normalizer Brauer support derived from canonical reductions. The
SDefects input is removed; the same normalized map, retained models, explicit
Brauer sign formula and complete previous result are preserved. -/

noncomputable section
set_option maxHeartbeats 4000000
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3CanonicalSupportDefinition41
...
theorem p3_definition41_from_canonical_support
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3CanonicalSupportDefinition41
