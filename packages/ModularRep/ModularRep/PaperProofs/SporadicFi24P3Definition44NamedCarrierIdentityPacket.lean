...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityBlocks
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityPacket
...
open ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityBlocks
...
def identityPacket (P : Definition35Problem.{u})
    ...
    (source : RawReductionSource (k := P.k) V)
  ...
  refine {
    ...
    intermediateBlocks := fun J hJ => allIntermediateBlockData P psi.1 V
      source.normalizerRoot source.localBrauer source.localBrauer_reduction
      compatibility fieldSource hrawBlock J hJ
    qOne := fun hV => localBrauer_atOne P.iota Omega D T hOne psi.1 V hclass source hV }
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityPacket
