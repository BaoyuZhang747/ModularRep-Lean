...
/-!
# Representative local maps from the same Fischer correspondence

This is the generic representative-fibre argument, with only its two upstream
imports. Its construction preserves the actual raw-character weight class.
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierRepresentativeMaps
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierRepresentativeMaps
