import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessQOneExtensionAssembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessQOneBlockAssembly
...
theorem centerless_manuscript_qOne_intermediate_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon⟩ :=
    SporadicFi24P3Definition44NamedCarrierCenterlessQOneExtensionAssembly.centerless_manuscript_qOne_extension_assembly iota R compatibility availability Dzero Tzero nu0 hcenter hOuter principle seed Bzero e0 hblock he0
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon,
    centerless_common_block_output iota
      (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
      R R.1.operations.ambientBlockData.blocks ⟨⟩ hcenter hOuter ambient⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessQOneBlockAssembly
