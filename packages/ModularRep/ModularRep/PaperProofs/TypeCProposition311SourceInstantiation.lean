...
namespace ModularRep.PaperProofs.TypeCProposition311SourceInstantiation
...
theorem proposition_3_11_source_instantiated
    ...
    let ordinaryStable : ∀ (j : J) (x : Basic),
      ...
      rw [TypeBSpecialCliffordActionAdapter.ordinarySeriesBlockMap_equivariant
        G0 field hinvariant D series ordinaryBlock hseries
          ordinaryBlockEquivariant]
  ...
  have hBrauer : ∀ (j : J) (phi : IBr iota),
    ...
    intro j phi
    rfl
  let basicSet := TypeBSpecialCliffordActionAdapter.ordinarySeriesBasicSet
    Msys iota hcompat hinj series linearEquiv hdecomposition
  let ambientActions := TypeBSpecialCliffordActionAdapter.labelledKZeroActionData
  ...
  have ambientNatural : DecompositionNatural (A := A)
    ...
    TypeBSpecialCliffordActionAdapter.decompositionNatural
...
end ModularRep.PaperProofs.TypeCProposition311SourceInstantiation
