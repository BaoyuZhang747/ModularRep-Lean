...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerPhysicalRows
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerCenterlessRows
...
open SporadicFi24P3Definition44NamedCarrierSignedBrauerPhysicalRows
...
theorem centerless_positive_block_output_of_signed_brauer
  ...
  exact every_embedded_physical_model_pair_blocks_of_signed_brauer iota phi.val V source
    ...
    h2 (actual_quotient_card_le_two iota phi.val hOuter) (fun n => rfl) hinj R.1.operations.ambientBlockData dataN
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerCenterlessRows
