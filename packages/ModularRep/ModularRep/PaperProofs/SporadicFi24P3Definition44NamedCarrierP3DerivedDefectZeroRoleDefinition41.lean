...
The block of every global defect-zero reduction is derived from the literal
V3 rows, ordinary defect-zero singleton law and actual bottom-support block.
Global reduction existence remains derived from canonical local availability.
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedDefectZeroRoleDefinition41
...
theorem p3_definition41_from_derived_defect_zero_role
  ...
  exact SporadicFi24P3Definition44NamedCarrierP3DerivedReductionDefinition41.p3_definition41_from_derived_reduction
      ...
      (hregular := hregular) (SDefects := SDefects) (hDefect := hDefect) (dz := dz)
      hcenter principle S9295 S9495 S820 fieldSource Bzero hdz

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedDefectZeroRoleDefinition41
