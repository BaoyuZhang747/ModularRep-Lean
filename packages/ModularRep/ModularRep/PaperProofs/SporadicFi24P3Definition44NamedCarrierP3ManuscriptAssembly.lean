...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ManuscriptAssembly
...
theorem p3_manuscript_from_local_and_v3_sources
  ...
  obtain ⟨Omega, hOmega, hblock, hOne⟩ :=
    exists_normalized_correspondence_from_p3_sources
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ManuscriptAssembly
