...
/-!
# Type C constituent factorization with finite splitting coefficients

This current coefficient adapter retains the earlier complete proof body.
Ordinary simple labels use the checked characteristic-zero constructor,
without algebraic closure of the modular-system fraction field.
...
namespace ModularRep.PaperProofs.TypeCCurrentConstituentFactorization
...
end ModularRep.PaperProofs.TypeCCurrentConstituentFactorization
