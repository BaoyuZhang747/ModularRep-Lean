import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulBlockAssembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulQOneAssembly
...
theorem faithful_manuscript_qOne_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks⟩ :=
    SporadicFi24P3Definition44NamedCarrierFaithfulBlockAssembly.faithful_manuscript_block_assembly iota R hOuter tau hcard hinverts compatibility availability nu0 e0 hblock he0
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulQOneAssembly
