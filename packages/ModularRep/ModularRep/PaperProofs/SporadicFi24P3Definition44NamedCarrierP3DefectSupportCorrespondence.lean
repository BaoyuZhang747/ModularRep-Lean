...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DefectSupportCorrespondence
...
theorem exists_normalized_correspondence_from_defect_support :
  ...
  obtain ⟨hBzero, hWzero, hBzeroFixed, hWzeroFixed⟩ :=
    selected_defectZero_signature iota (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota) R availability compatibility Dzero Tzero
      Bzero SDefects dz (roles 2) hDefect hdz tau fixedDefectZero
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DefectSupportCorrespondence
