import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCanonicalFi24Join
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCanonicalFi24Definition41
...
theorem exists_definition41_of_fi24_sources
    ...
    Nonempty (SporadicFi24P3Definition44NamedCarrierCanonicalDefinition41.Definition41Witness
      iota hinj R C Cover hCenter D T) := by
  obtain ⟨Omega, hOmega, hblock, hOne, hfamily⟩ :=
    SporadicFi24P3Definition44NamedCarrierCanonicalFi24Join.exists_normalized_correspondence_with_canonical_named_pairs
      ...
      RadicalSupport WeightActionAlignment hOuterQuotientCard C haut principle
  ...
  exact ⟨SporadicFi24P3Definition44NamedCarrierCanonicalDefinition41.ofNormalizedFamily
    iota hinj R C Cover hCenter D T Omega hOmega hblockOps hOne compatibility
    (fi24ThreeBlockSourceOfBindings blocks Involution
      BlockInjection.toBlockIndexBinding BlockAction) haut (Classical.choice hfamily)⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCanonicalFi24Definition41
