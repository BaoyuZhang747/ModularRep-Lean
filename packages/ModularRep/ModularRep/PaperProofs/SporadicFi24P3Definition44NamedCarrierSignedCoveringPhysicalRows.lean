import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringModelRows
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringPhysicalRows
...
open SporadicFi24P3Definition44NamedCarrierSignedCoveringModelRows
...
theorem every_embedded_physical_model_pair_blocks_of_index_two
    (eG : G ≃* B)
  ...
  exact embedded_model_pair_blocks_of_index_two B D (iota.alongMulEquiv eG) (source.normalizerRoot.alongMulEquiv eN) (IrreducibleBrauerCharacter.alongMulEquiv iota eG phi) (IrreducibleBrauerCharacter.alongMulEquiv source.normalizerRoot eN source.localBrauer) WG.ρ WL.ρ MG ML hMG hML
    h2 hIndex S820 hirrG haffordsG hirrL haffordsL seed hcyclic
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringPhysicalRows
