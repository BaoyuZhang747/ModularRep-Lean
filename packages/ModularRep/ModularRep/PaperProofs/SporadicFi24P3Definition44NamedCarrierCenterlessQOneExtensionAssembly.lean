...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessQOneExtensionAssembly
...
theorem centerless_manuscript_qOne_extension_assembly
    ...
    ∀ (_ : ∀ phi : FaithfulIBr iota inj bs R routine,
      ...
      ∃ (e : FaithfulIBr iota inj bs R routine ≃ FaithfulWeight iota inj bs R routine)
        ...
        CenterlessCommonOutput iota inj R bs routine hcenter e := by
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne⟩ :=
    SporadicFi24P3Definition44NamedCarrierCenterlessQOneAssembly.centerless_manuscript_qOne_assembly iota R compatibility availability Dzero Tzero nu0 hcenter hOuter principle Bzero e0 hblock he0
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne,
    centerless_common_output iota
      (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
      R R.1.operations.ambientBlockData.blocks ⟨⟩ hcenter e availability compatibility
      Dzero Tzero hQOne seed⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessQOneExtensionAssembly
