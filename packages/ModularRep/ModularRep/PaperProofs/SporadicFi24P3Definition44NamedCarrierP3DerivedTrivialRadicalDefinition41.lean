...
The trivial-weight source is derived from the retained specified defect-zero block.
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedTrivialRadicalDefinition41
...
theorem p3_definition41_from_derived_trivial_radical
  ...
  let Tzero : TrivialWeightSource (p := 3) (X := G) :=
    SporadicFi24P3Definition44NamedCarrierTrivialRadicalOfDefectZero.trivialWeightSourceOfDefectBot
      R.1.operations.ambientBlockData.blocks (roles 2) hDefect
  exact SporadicFi24P3Definition44NamedCarrierP3DerivedBlockStabilityDefinition41.p3_definition41_from_derived_block_stability
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedTrivialRadicalDefinition41
