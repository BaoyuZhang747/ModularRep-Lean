import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulQOneExtensionAssembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulQOneBlockAssembly
...
theorem faithful_manuscript_qOne_intermediate_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon⟩ :=
    SporadicFi24P3Definition44NamedCarrierFaithfulQOneExtensionAssembly.faithful_manuscript_qOne_extension_assembly iota R hOuter tau hcard hinverts compatibility availability Dzero Tzero nu0 Bzero e0 hblock he0
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulQOneBlockAssembly
