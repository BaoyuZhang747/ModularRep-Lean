import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityPacket
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityFamily
...
open ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityPacket
...
def ofNormalizedEquiv
    ...
    Definition41Witness iota hinj R localReduction Cover hc D T := by
  refine {
    Omega := Omega
    equivariant := hOmega
  ...
  let psi := ownBrauerAt iota hinj R localReduction xi.1
  ...
  refine identityPacket P hc psi allInner Omega D T hOne V hclass
    (rawReductionOfSelected R.1 localReduction V) compatibility fieldSource ?_
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIdentityFamily
