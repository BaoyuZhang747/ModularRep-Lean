...
import ModularRep.PaperProofs.TypeCCurrentProposition311
...
namespace ModularRep.PaperProofs.TypeCCurrentProposition313
...
theorem labelToWeight_combined_equivariant
    ...
    (rho : TypeCCurrentProposition311.OrdinarySeriesCarrier series ≃
...
theorem proposition_3_13_condition_ii_source_instantiated
  ...
  have hordinaryBlock : ∀ (a : A) (x : Basic),
    ...
    intro a x
    exact TypeBSpecialCliffordActionSplitting.ordinarySeriesBlockMap_equivariant
  ...
  have alphaExists : RepresentativeEquivExists
    ...
    obtain ⟨e, he⟩ :=
      TypeCCurrentProposition311.proposition_3_11_source_instantiated
...
end ModularRep.PaperProofs.TypeCCurrentProposition313
