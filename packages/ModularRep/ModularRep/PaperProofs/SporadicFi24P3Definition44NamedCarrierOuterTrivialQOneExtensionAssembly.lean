...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOuterTrivialQOneExtensionAssembly
...
theorem outer_trivial_manuscript_qOne_extension_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne⟩ :=
    SporadicFi24P3Definition44NamedCarrierOuterTrivialQOneAssembly.outer_trivial_manuscript_qOne_assembly iota R hOuter hcard compatibility availability Dzero Tzero nu0 Bzero e0 hblock
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOuterTrivialQOneExtensionAssembly
