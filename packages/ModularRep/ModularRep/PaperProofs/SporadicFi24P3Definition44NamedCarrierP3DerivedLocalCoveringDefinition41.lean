import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierDerivedCoveringCenterlessRows
...
/-! The complete centreless manuscript deduction with local covering
derived from the retained factor-one model and its literal restriction.
The same normalized global map carries every model and intermediate block
conclusion. Only the general S9295 restriction-covering input is removed;
all previous inputs and the complete previous result are retained. -/

noncomputable section
set_option maxHeartbeats 4000000
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedLocalCoveringDefinition41
...
open SporadicFi24P3Definition44NamedCarrierDerivedCoveringCenterlessRows
...
theorem p3_definition41_from_derived_local_covering
  ...
  have hPositive := centerless_positive_block_output_of_model_restriction iota
    (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
    R R.1.operations.ambientBlockData.blocks routine hcenter hOuter e hBlocks
    S9495 S820 fieldSource ambient seed localInputs
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedLocalCoveringDefinition41
