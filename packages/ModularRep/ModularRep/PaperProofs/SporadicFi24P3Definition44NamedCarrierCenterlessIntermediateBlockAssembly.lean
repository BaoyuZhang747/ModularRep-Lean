...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessIntermediateBlockAssembly
...
theorem centerless_manuscript_intermediate_block_assembly
    ...
    ∀ (_ : ∀ phi : FaithfulIBr iota inj bs R routine,
      ...
      (_ : CenterlessPositiveLocalInputs iota inj R bs routine)
      ...
      ∃ (e : FaithfulIBr iota inj bs R routine ≃ FaithfulWeight iota inj bs R routine)
        ...
        CenterlessCommonBlockOutput iota inj R bs routine hcenter ∧
        CenterlessPositiveBlockOutput iota inj R bs routine hcenter e := by
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks⟩ :=
    SporadicFi24P3Definition44NamedCarrierCenterlessQOneBlockAssembly.centerless_manuscript_qOne_intermediate_assembly iota R compatibility availability Dzero Tzero nu0 hcenter hOuter principle ambient seed Bzero e0 hblock he0
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks,
    centerless_positive_block_output iota
      (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
      R R.1.operations.ambientBlockData.blocks ⟨⟩ hcenter hOuter e hBlocks
      S9295 S9495 S820 fieldSource ambient seed localInputs⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCenterlessIntermediateBlockAssembly
