import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3IntervalDefinition41
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ProjectorCoefficients

/-! The full prime-three manuscript deduction with the role-two modular
coefficients derived from selected ordinary values and uniform integral scalar
descent. The preceding complete conclusion and all other inputs are retained. -/

noncomputable section
set_option maxHeartbeats 4000000
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ProjectorDefinition41
...
theorem p3_definition41_from_ordinary_projector :
  ...
  ∀ c, (R.1.operations.ambientBlockData.blockIdempotent (roles 2)).coeff (classRepresentatives c) =
    (inverseCharacterValues c : k) / (7031383654400 : k) := by
      ...
      exact block_coefficients_of_selected_values R.1.operations.ambientBlockData.blocks
        ...
        classRepresentatives classCover classCentralizers
        selectedForwardValues selectedInverseValues scalarDescent
  exact SporadicFi24P3Definition44NamedCarrierP3IntervalDefinition41.p3_definition41_from_derived_interval
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ProjectorDefinition41
