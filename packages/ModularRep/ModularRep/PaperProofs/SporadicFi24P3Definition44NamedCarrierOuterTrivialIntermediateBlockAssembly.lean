import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOuterTrivialQOneBlockAssembly
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierPhysicalOriginalBlockRows

/-! The complete original-group intermediate block law on the SAME retained models. -/

noncomputable section
set_option maxHeartbeats 2000000
open scoped MonoidAlgebra

namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOuterTrivialIntermediateBlockAssembly
...
/-- Retain every completed witness and derive the full intermediate block law for both original-group models. -/
theorem outer_trivial_manuscript_intermediate_assembly
    ...
    ∀ (_ : DefectZeroOrdinaryBlockSource iota inj bs Dzero)
      ...
      ∃ (e : FaithfulIBr iota inj bs R routine ≃ FaithfulWeight iota inj bs R routine)
        ...
        MatchedOriginalModelBlockOutput iota inj R bs routine e := by
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks⟩ :=
    SporadicFi24P3Definition44NamedCarrierOuterTrivialQOneBlockAssembly.outer_trivial_manuscript_qOne_intermediate_assembly iota R hOuter hcard compatibility availability Dzero Tzero nu0 Bzero e0 hblock
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks,
    matched_original_model_block_output iota
      (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
      R R.1.operations.ambientBlockData.blocks ⟨⟩ e hBlocks⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOuterTrivialIntermediateBlockAssembly
