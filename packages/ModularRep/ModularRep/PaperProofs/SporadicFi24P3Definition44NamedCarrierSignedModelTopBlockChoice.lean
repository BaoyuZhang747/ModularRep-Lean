...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringExtension
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedModelTopBlockChoice

open ModularRep.FDRepSimpleClassKZero
open SporadicFi24P3Definition44NamedCarrierSignedCoveringExtension
...
accepted. -/
theorem exists_global_extension_with_induced_block_of_index_two
    {p : Nat} {k K A : Type u}
  ...
  obtain ⟨global, hglobalBlock⟩ := exists_extension_in_covering_block_of_index_two
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedModelTopBlockChoice
