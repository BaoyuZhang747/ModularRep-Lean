import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerModelRows
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerPhysicalRows
...
open SporadicFi24P3Definition44NamedCarrierSignedBrauerModelRows
...
theorem every_embedded_physical_model_pair_blocks_of_signed_brauer
    (eG : G ≃* B)
  ...
  exact embedded_model_pair_blocks_of_signed_brauer B D (iota.alongMulEquiv eG) (source.normalizerRoot.alongMulEquiv eN) (IrreducibleBrauerCharacter.alongMulEquiv iota eG phi) (IrreducibleBrauerCharacter.alongMulEquiv source.normalizerRoot eN source.localBrauer) WG.ρ WL.ρ MG ML hMG hML
    h2 hIndex hirrG haffordsG hirrL haffordsL seed
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerPhysicalRows
