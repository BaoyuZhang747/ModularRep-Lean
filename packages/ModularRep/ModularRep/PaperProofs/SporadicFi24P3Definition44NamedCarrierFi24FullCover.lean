import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFi24Definition41
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSelfCover

/-! The actual full universal cover with kernel of order three supplies
the universal 3-prime cover and centreless group used by the final join.
All remaining Fischer and canonical-supplement identifications stay explicit. -/
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFi24FullCover
...
theorem exists_definition41_of_full_cover_and_fi24_sources
    ...
    (catalogues : ∀ (b : ActualBlock (k := k) (X := X))
      ...
      BlockInjection.toBlockIndexBinding BlockAction) (SporadicFi24P3Definition44NamedCarrierSelfCover.center_eq_bot_of_nonabelian_simple hsimple hnonabelian) M.theta haut) :
    Nonempty (SporadicFi24P3Definition44NamedCarrierDefinition41.Definition41Witness
      iota hinj R localReduction
      (SporadicFi24P3Definition44NamedCarrierSelfCover.identityThreePrimeCover_of_fullCover_kernel_card_three
        cover hcover hkernel hsimple hnonabelian)
      (SporadicFi24P3Definition44NamedCarrierSelfCover.center_eq_bot_of_nonabelian_simple hsimple hnonabelian)
      D T) := by
  exact SporadicFi24P3Definition44NamedCarrierFi24Definition41.exists_definition41_of_fi24_sources
    iota hinj blocks E1 AD Bridge
    (SporadicFi24P3Definition44NamedCarrierSelfCover.identityThreePrimeCover_of_fullCover_kernel_card_three
      cover hcover hkernel hsimple hnonabelian)
    (SporadicFi24P3Definition44NamedCarrierSelfCover.center_eq_bot_of_nonabelian_simple hsimple hnonabelian)
    Involution BlockInjection BlockAction D T DefectZeroCompatibility DefectZeroBlocks
    DefectZeroSubgroups DefectZeroIdentification RestrictionBinding V3 LiteralBinding
    Q table S414 TableBlockMatch LocalCensus RadicalSupport WeightActionAlignment
    hOuterQuotientCard localReduction haut principle S9295 S9495 S820 seed fieldSource
    compatibility catalogues

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFi24FullCover
