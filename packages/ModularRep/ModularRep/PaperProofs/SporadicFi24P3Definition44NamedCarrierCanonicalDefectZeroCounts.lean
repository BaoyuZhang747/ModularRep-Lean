...
The selected radical-bottom property is derived from the actual canonical
normalizer representation and maximal Brauer support at the nominated
ambient block. No normalizer-defect source is required. -/

noncomputable section
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCanonicalDefectZeroCounts
...
theorem selected_defectZero_signature_of_canonical_support
    {p : ℕ} {k K X : Type u}
  ...
  have hBot (W : CharacterWeight p K X)
      ...
      W.subgroup = ⊥ :=
    rawWeight_subgroup_eq_bot_of_canonical_reduction iota R availability compatibility b hDefect W (hW.trans hbd)
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCanonicalDefectZeroCounts
