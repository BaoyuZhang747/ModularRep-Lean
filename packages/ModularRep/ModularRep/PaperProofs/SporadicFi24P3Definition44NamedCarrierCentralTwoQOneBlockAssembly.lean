import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoQOneExtensionAssembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoQOneBlockAssembly
...
theorem central_two_manuscript_qOne_intermediate_assembly
    ...
    ∀ (_ : ∀ phi : FaithfulIBr iota inj bs R routine,
      ...
      ∃ (e : FaithfulIBr iota inj bs R routine ≃ FaithfulWeight iota inj bs R routine)
        ...
        CentralTwoCommonBlockOutput iota inj R bs routine E hC := by
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon⟩ :=
    SporadicFi24P3Definition44NamedCarrierCentralTwoQOneExtensionAssembly.central_two_manuscript_qOne_extension_assembly iota R E hC hOuter hAut hZ compatibility availability Dzero Tzero nu0 principle seed Bzero e0 hblock he0
  exact ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon,
    central_two_common_block_output iota
      (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
      R R.1.operations.ambientBlockData.blocks ⟨⟩ E hC ambient⟩

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoQOneBlockAssembly
