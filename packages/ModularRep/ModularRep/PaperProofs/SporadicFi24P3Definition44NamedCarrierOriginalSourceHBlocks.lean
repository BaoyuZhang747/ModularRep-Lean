...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOriginalSourceHBlocks
...
def sourceHBlockData {P : Definition35Problem.{u}} {psi : Definition35Brauer P}
    {V : CharacterWeight P.p P.K P.H} (packet : OriginalActualWeightPacket P psi V)
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOriginalSourceHBlocks
