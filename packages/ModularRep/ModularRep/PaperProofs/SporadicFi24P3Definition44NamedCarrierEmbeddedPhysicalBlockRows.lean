...
/-! The original matched base induction supplies every embedded model pair.
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierEmbeddedPhysicalBlockRows
...
theorem every_embedded_physical_model_pair_blocks
    (eG : G ≃* B)
  ...
  exact embedded_model_pair_blocks B D (iota.alongMulEquiv eG) (source.normalizerRoot.alongMulEquiv eN) (IrreducibleBrauerCharacter.alongMulEquiv iota eG phi) (IrreducibleBrauerCharacter.alongMulEquiv source.normalizerRoot eN source.localBrauer) WG.ρ WL.ρ MG ML hMG hML
    S9295 S9495 S820 hirrG haffordsG hirrL haffordsL seed fieldSource hcyclic
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierEmbeddedPhysicalBlockRows
