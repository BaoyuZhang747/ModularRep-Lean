import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoBlockAssembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoQOneAssembly
...
theorem central_two_manuscript_qOne_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks⟩ :=
    SporadicFi24P3Definition44NamedCarrierCentralTwoBlockAssembly.central_two_manuscript_block_assembly iota R E hC hOuter hAut hZ compatibility availability nu0 principle e0 hblock he0
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierCentralTwoQOneAssembly
