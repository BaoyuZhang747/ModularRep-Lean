import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3CanonicalSupportCorrespondence
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerCenterlessRows
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierIndexTwoQOneAssembly
...
/-! The complete centreless prime-three deduction with modular extensions proved
from the actual quotient cardinal bounds. The cyclic-extension principle is
removed; the full preceding result, same map, models, roots and Q=1 laws remain. -/

noncomputable section
set_option maxHeartbeats 4000000
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3IndexTwoDefinition41
...
include AD Bridge hOuter ordinaryComplete ordinaryValues
  fusion support rowBijective S414 evaluation stable localFixed availability compatibility hDefect dz

theorem p3_definition41_from_index_two_extension
  ...
  obtain ⟨Omega, hOmega, hblock, hOne⟩ :=
    SporadicFi24P3Definition44NamedCarrierP3CanonicalSupportCorrespondence.exists_normalized_correspondence_from_canonical_support
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks⟩ :=
    SporadicFi24P3Definition44NamedCarrierIndexTwoQOneAssembly.centerless_manuscript_qOne_intermediate_of_index_two
      iota R compatibility availability Dzero Tzero nu0 hcenter hOuter
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3IndexTwoDefinition41
