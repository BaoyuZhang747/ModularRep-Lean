import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedCoveringCenterlessRows
...
covering-block extension selected by the actual quotient sign. S9495 and
its unused coefficient field binder are removed; the same normalized map,
retained models and complete previous result are preserved. -/

noncomputable section
set_option maxHeartbeats 4000000
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3SignedCoveringDefinition41
...
open SporadicFi24P3Definition44NamedCarrierSignedCoveringCenterlessRows
...
theorem p3_definition41_from_signed_covering
  ...
  have hPositive := centerless_positive_block_output_of_signed_covering iota
    (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
    R R.1.operations.ambientBlockData.blocks routine hcenter hOuter e hBlocks
    (by
      intro h
      have hdiv := (CharP.cast_eq_zero_iff k 3 2).mp h
      norm_num at hdiv) S820 ambient seed localInputs
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3SignedCoveringDefinition41
