import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3IdempotentDefinition41
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ClassCentre

/-! Full prime-three conclusion with the centreless premise derived from
the already supplied complete class cover and centralizer-order table.
No new specified realization input is introduced. -/

noncomputable section
set_option maxHeartbeats 4000000
open scoped MonoidAlgebra
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ClassCentreDefinition41
...
theorem p3_definition41_from_full_class_table :
  ...
  let hcenter := center_eq_bot_of_full_centralizer_table
    classRepresentatives classCover classCentralizers C.groupOrder
  exact SporadicFi24P3Definition44NamedCarrierP3IdempotentDefinition41.p3_definition41_from_idempotent_coefficients
    ...
    (classCentralizers := classCentralizers) (blockCoefficients := blockCoefficients) hcenter

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ClassCentreDefinition41
