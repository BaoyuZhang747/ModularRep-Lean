...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedPCoreDefinition41
...
theorem p3_definition41_from_derived_pcore
  ...
  exact SporadicFi24P3Definition44NamedCarrierP3DefectSupportDefinition41.p3_definition41_from_defect_support
      ...
      (Dzero := Dzero) (Tzero := Tzero) (Bzero := Bzero) (SDefects := toDefectSources R SDefects) (hDefect := hDefect) (dz := dz) (hdz := hdz)
      hcenter principle S9295 S9495 S820 fieldSource

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3DerivedPCoreDefinition41
