...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerTopBlockChoice
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerModelRows
...
open SporadicFi24P3Definition44NamedCarrierSignedBrauerTopBlockChoice
...
theorem embedded_model_pair_blocks_of_signed_brauer
    (h2 : (2 : k) ≠ 0)
  ...
  · obtain ⟨BA, ⟨dataA⟩⟩ := ambient hB
    ...
    have hresG : sigmaG.pullback B.subtype = rhoG := by
      ...
      rw [MG.restriction]
    obtain ⟨selectedGlobal, lambda, htwist, htop⟩ :=
      exists_global_twisted_extension_with_induced_block_of_index_two
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierSignedBrauerModelRows
