...
/-! Actual block totals and outer fixed-point totals construct the one
normalized equivariant correspondence and every original triple-cover
packet. The literal numerical/source bindings remain explicit. -/

noncomputable section
set_option maxHeartbeats 4000000

namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOriginalTripleCoverNumerical
...
theorem exists_definition41_of_actual_counts
    ...
    Nonempty (Definition41Witness iota hinj R C
      (ellPrimeCover_of_fullCover_kernel_three iota.prime hpne q hq hs hna hkernel) D T) := by
  obtain ⟨Omega, hOmega, hblock⟩ :=
    exists_actual_equivariant_of_counts iota hinj R tau decomposition counts
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierOriginalTripleCoverNumerical
