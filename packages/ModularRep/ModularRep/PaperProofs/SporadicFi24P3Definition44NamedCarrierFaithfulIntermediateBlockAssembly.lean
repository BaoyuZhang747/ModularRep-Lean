import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulQOneBlockAssembly
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulIntermediateBlockAssembly
...
theorem faithful_manuscript_intermediate_assembly
  ...
  obtain ⟨e, hFamily, hIndependent, hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks⟩ :=
    SporadicFi24P3Definition44NamedCarrierFaithfulQOneBlockAssembly.faithful_manuscript_qOne_intermediate_assembly iota R hOuter tau hcard hinverts compatibility availability Dzero Tzero nu0 Bzero e0 hblock he0
...
end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierFaithfulIntermediateBlockAssembly
