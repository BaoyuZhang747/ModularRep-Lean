import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ManuscriptAssembly
...
import ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3ReferenceCorrespondence
...
namespace ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3Definition41Assembly
...
open SporadicFi24P3Definition44NamedCarrierP3ReferenceCorrespondence

open SporadicFi24P3Definition44NamedCarrierP3ManuscriptAssembly
...
theorem p3_definition41_from_local_and_v3_sources
  ...
  obtain ⟨Omega, hOmega, hblock, hOne, e, hFamily, hlink, hIndependent,
    hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks, hPositive⟩ :=
    p3_manuscript_from_local_and_v3_sources
      (iota := iota) (R := R) (roles := roles) (AD := AD) (Bridge := Bridge)
      (hOuter := hOuter) (tau := tau) (htau := htau)
      ...
      (representatives := representatives) (encoding := encoding) (V3 := V3)
      ...
      (Dzero := Dzero) (Tzero := Tzero) (Bzero := Bzero) (Zzero := Zzero) (dz := dz) (hdz := hdz)
      hcenter principle S9295 S9495 S820 fieldSource ambient seed localInputs
  refine ⟨Omega, hOmega, hblock, hOne, e, hFamily, hlink, hIndependent,
    hFixed, hAD3, hBlocks, hQOne, hCommon, hCommonBlocks, hPositive, ?_⟩
  exact definition41_data_of_original_rows iota
    ...
    (original_rows_of_retained_family iota
      (FDRepSimpleClassKZero.irreducibleBrauerCharacterInjectivity_of_rootEmbedding iota)
      R.1.operations.ambientBlockData.blocks R ⟨⟩ hcenter Omega hOmega e hFamily.1
      hlink hAD3 hBlocks hCommon hCommonBlocks hPositive) hOne

end ModularRep.PaperProofs.SporadicFi24P3Definition44NamedCarrierP3Definition41Assembly
